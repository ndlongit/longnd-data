...
public class AppInfoController extends AbstractController {
    ...
    protected static final String REAL_NAME_SPACE = "/app";
    protected static final String NAME_SPACE = ADMIN_NAME_SPACE + REAL_NAME_SPACE;
    ...
    public ModelAndView init(@ModelAttribute(MODEL_NAME) AppInfo app, BindingResult result) {
        // TODO Modify later
        ModelAndView mnv = initModelAndView(REAL_NAME_SPACE + "/uploadApp");
    ...
    public ModelAndView createApp(@ModelAttribute(MODEL_NAME) AppInfo app, BindingResult result) {
        ...
        ModelAndView mnv = initModelAndView(REAL_NAME_SPACE + "/listApps");
        return mnv;
    }
    ...
    public ModelAndView editAppPre(@PathVariable("id") String appId) {
        ...
        return new ModelAndView(REAL_NAME_SPACE + "/uploadApp");
    }
