...
public class TplanmBaseNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _TplanmBaseNames extends PropertyName<Tplanm> {

        /**
         * インスタンスを構築します。
         */
        public _TplanmBaseNames() {
            super();
        }
         ...
         *            名前
         */
        public _TplanmBaseNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _TplanmBaseNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
