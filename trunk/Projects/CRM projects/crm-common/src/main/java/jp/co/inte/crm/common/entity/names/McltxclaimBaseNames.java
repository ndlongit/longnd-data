...
import jp.co.inte.crm.common.entity.names.TclaimNames._TclaimNames;
import org.seasar.extension.jdbc.name.PropertyName;

/**
 * {@link Mcltxclaim}のプロパティ名の集合です。
 * 
 */
...
public class McltxclaimBaseNames {
     ...
     * tclaimのプロパティ名を返します。
     * 
     * @return tclaimのプロパティ名
     */
    public static _TclaimNames tclaim() {
        return new _TclaimNames("tclaim");
    }

    /**
     * @author S2JDBC-Gen
     */
    public static class _McltxclaimBaseNames extends PropertyName<Mcltxclaim> {

        /**
         * インスタンスを構築します。
         */
        public _McltxclaimBaseNames() {
            super();
        }
         ...
         *            名前
         */
        public _McltxclaimBaseNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _McltxclaimBaseNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return tclaimのプロパティ名
         */
        public _TclaimNames tclaim() {
            return new _TclaimNames(this, "tclaim");
        }
    }
}
