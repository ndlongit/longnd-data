...
public class WsOrganisationGeoResultSet  implements java.io.Serializable {
    ...
    public WsOrganisationGeoResultSet(
           ...
           int codeRetour,
           com.structis.argos.ws.WsOrganisationGeoType[] listeRetour) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WsOrganisationGeoResultSet)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WsOrganisationGeoResultSet.class, true);
