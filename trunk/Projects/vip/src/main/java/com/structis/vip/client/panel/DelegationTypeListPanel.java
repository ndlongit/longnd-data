...
public class DelegationTypeListPanel extends AbstractPanel {
    ...
    private void initUI() {
        ...
        ColumnConfig name = new ColumnConfig(DelegationTypeModel.DELEGATION_TYPE_NAME, messages.delegationtypenom(), 200);
        ColumnConfig code = new ColumnConfig(DelegationTypeModel.DELEGATION_TYPE_DESCRIPTION, messages.delegationtypedescription(), 580);
