...
public class ControlTypeFormPanel extends AbstractPanel {
    ...
    private void save() {
        ...
        if (isEdit == false) {
            clientControlTypeService.insert(model, new AsyncCallbackWithErrorResolution<ControlTypeModel>() {
            ...
            clientControlTypeService.update(model, new AsyncCallbackWithErrorResolution<ControlTypeModel>() {
