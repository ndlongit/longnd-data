...
/**
 * Interface qui contient les constants associ�s � resource ActionMessages pour mapper le code d'erreur <-> messages
 * 
 * RDG, quatre digit avec le 1er digit comme le suivant :
 * <ul>
