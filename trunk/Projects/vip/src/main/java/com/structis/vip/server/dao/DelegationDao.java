...
public interface DelegationDao extends GenericDao<Delegation, Integer> {
	...
	List<Delegation> getValidDelegations(String perId, Integer natureId, Integer typeId,
			Integer statusId, Integer delegantId, Integer delegataireId,
	...
	List<Delegation> getValidDelegations(String enId, String perId,
			Integer natureId, Integer typeId, Integer statusId,
			Integer delegantId, Integer delegataireId, Date startDate,
			Date endDate, Boolean sep, Boolean conjointe,
			Boolean isDisplayAllLevel);
	...
	List<Delegation> getValidDelegations(String enId, String perId,
			...
			List<Integer> delegataireId, Date startDate, Date endDate,
			Boolean sep, Boolean conjointe, Boolean isDisplayAllLevel);
	Boolean hasOtherDelegation(Integer delegationId, Integer natureId,
			String perimetreId, String entiteId);
	Boolean hasRenewDelegation(Integer delegationId);	
	Boolean delegantIsDelegataireOfDelegation(Integer delegantId,
			Integer delegationId);
	Integer subDelegantIsDelegataireOfParent(Integer delId);
	List<Delegation> getDelegations(Boolean childLevel, String enId, String perId, List<Integer> natureIds,
	...
	List<DelegationDelegataire> findDelegataires(Integer delId, String perId,
			String entId);
