...
public interface ClientDocumentMdlServiceAsync {
    ...
    public static class Util {
        ...
        private static ClientDocumentMdlServiceAsync instance = GWT.create(ClientDocumentMdlService.class);
    ...
    void getDocumentsByDelegation(Integer delegationId, AsyncCallback<List<DomDelModel>> callback);
