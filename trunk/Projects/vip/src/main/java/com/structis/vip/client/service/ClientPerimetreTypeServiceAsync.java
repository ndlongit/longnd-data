...
public interface ClientPerimetreTypeServiceAsync {
    ...
    public static class Util {
        ...
        private static ClientPerimetreTypeServiceAsync instance = GWT.create(ClientPerimetreTypeService.class);
    ...
    void insert(PerimetreTypeModel model, AsyncCallback<PerimetreTypeModel> asyncCallback);

    void update(PerimetreTypeModel model, AsyncCallback<PerimetreTypeModel> asyncCallback);
}
