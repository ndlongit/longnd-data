...
//	private final Messages messages = GWT.create(Messages.class);
	...
	public void init(ServletConfig config) throws ServletException {
		super.init(config);
		clientUserService = (ClientUserService) SpringGetter.getBean(config.getServletContext(), "clientUserService");
		clientControlService = (ClientControlService) SpringGetter.getBean(config.getServletContext(), "clientControlService");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		UserModel user = clientUserService.findUserById(iUserId);
		...
		List<ControlModel> controls = clientControlService.getControls(filter);
		...
		try {			
			...
			header.append(",").append("Code Projet")
				  .append(",").append("Type de Contrôle")
				  .append(",").append("Date du Contrôle")
				  .append(",").append("Nom du Contrôleur Interne")
				  .append(",").append("Nom du Contrôleur Externe");
			...
			for (ControlModel cm: controls) {
				...
				String internName = cm.getCollaborateur() == null ? "" : cm.getCollaborateur().getLastname() + " " + cm.getCollaborateur().getFirstname();				
				
				line.append(perName)					
					.append(",").append(codeProjet)
					.append(",").append(controlType)
					.append(",").append(controlDate)
					.append(",").append(internName)
					.append(",").append(externName);
