...
public interface ClientCollaborateurService extends RemoteService {
	...
	List<CollaborateurModel> getAllCollaborateursByEntiteId(String entiteId,
	...
	List<CollaborateurModel> getAllDelegatairesByPerimeter(String perId,String entiteId);
	...
	List<CollaborateurModel> findByName(String name, String entityId,
			Boolean sortie, String sortedField, Integer sortDir, Integer start, Integer pageSize);
	...
	PagingLoadResult<CollaborateurModel> getAllCollaborateursByEntiteIdPaging(
			PagingLoadConfig loadConfig, String entId);
