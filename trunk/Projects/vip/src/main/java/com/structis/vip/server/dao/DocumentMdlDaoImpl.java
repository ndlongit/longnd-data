...
public class DocumentMdlDaoImpl extends HibernateGenericDao<DocumentMdl, Integer> implements DocumentMdlDao {
    ...
    public List<DocumentMdl> getDocumentModelsByLanguage(Integer lgId) {
        String sql = " from DocumentMdl d where d.language.id = :languageId " + "order by d.filename";
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<DocumentMdl> getDocumentModelsByLanguageAndType(Integer lgId, String type) {
        String sql = " from DocumentMdl d where d.language.id = :languageId " + " and d.type = :type order by d.filename";
    ...
    public List<DomDel> getDocumentsByDelegation(Integer delegationId) {
        String sql = " from DomDel dd where dd.delegation.id = :delegationId " + " order by dd.documentMdl.filename";
    ...
    public List<DomDel> getDocumentsByDelegationAndLanguage(Integer delegationId, Integer languageId) {
        String sql = " from DomDel dd where dd.delegation.id = :delegationId " + " and dd.documentMdl.language.id = :languageId "
    ...
    public List<DomDel> getDocumentsByDelegationLanguageAndType(Integer delegationId, Integer languageId, String type) {
        String sql = "select dd.documentMdl from DomDel dd where dd.delegation.id = :delegationId " + " and dd.documentMdl.type = :type "
                + " and dd.documentMdl.language.id = :languageId " + " order by dd.documentMdl.filename";
