...
public class SpringGetter {
	...
	public static Object getBean(ServletContext context, String name) {
		ClassPathXmlApplicationContext ecoContext = (ClassPathXmlApplicationContext) WebApplicationContextUtils
				.getWebApplicationContext(context).getBean("vip-context");
	...
	public static Object getBatchBean(String name){
		ClassPathXmlApplicationContext batchContext = new ClassPathXmlApplicationContext(
				...
				"classpath:com/structis/vip/server/spring/persistance-context.xml",
				"classpath:com/structis/vip/server/spring/dozer-context.xml",
				"classpath:com/structis/vip/server/spring/manager-context.xml",
