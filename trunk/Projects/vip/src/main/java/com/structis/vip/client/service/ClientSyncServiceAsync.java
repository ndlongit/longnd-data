...
public interface ClientSyncServiceAsync {
	public static class Util {
		private static ClientSyncServiceAsync instance = GWT
				.create(ClientSyncService.class);
	...
	void syncRUBISWithItems(String entId, List<SynETDEModel> models,
			AsyncCallback<List<CollaborateurModel>> asyncCallback);

	void getRubsiCodesName(String entId,String entName,
			AsyncCallback<List<SynETDEModel>> asyncCallback);
