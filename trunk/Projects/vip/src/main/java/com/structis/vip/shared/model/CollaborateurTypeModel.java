...
public class CollaborateurTypeModel extends BaseModelDataActivable {
	...
	public String getDescription() {
		return get(COT_DESCRIPTION);
	}

	public void setDescription(String description) {
		set(COT_DESCRIPTION, description);
	}

	public EntiteModel getEntite() {
		return get(COT_ENTITE);
	}

	public void setEntite(EntiteModel entite) {
		set(COT_ENTITE, entite);
	}
...
//	}	
	...
	public String getGroupName() {
		return get(COT_GROUP_NAME);
	}

	public void setGroupName(String groupName) {
		set(COT_GROUP_NAME, groupName);
	}		
