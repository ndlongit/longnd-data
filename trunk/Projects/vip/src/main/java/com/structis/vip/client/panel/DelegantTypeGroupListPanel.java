		...
		final Listener<MessageBoxEvent> l = new Listener<MessageBoxEvent>() {
			public void handleEvent(MessageBoxEvent ce) {
				...
				if (txtReturn.equals(btn.getText())) {
					...
					clientDelegantTypeGroupService.delete(model, new AsyncCallback<Boolean>() {
						@Override
						public void onSuccess(Boolean arg0) {
							initData();
							Info.display(messages.commoninfo(), messages.deleganttypegroupmessagedeletesuccessfully());
						}
