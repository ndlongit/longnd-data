...
public class PrintDelegationGridServiceServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(delegationList != null && delegationList.length > 0){
			...
			List<Delegation> delegations = domDelegationService.getAllDelegationById(delegationIds);
	    	...
	    	out.println(
	    		"<thead>" + 
					"<tr>" + 
						"<th style=\"width: 15%;\">" + messages.perimetre() +"</th>"  + 
						"<th style=\"width: 15%;\">" + messages.nature() + "</th>" + 
						"<th style=\"width: 15%;\">" + messages.delegant() + "</th>" + 
						"<th style=\"width: 15%;\">" + messages.delegataire() + "</th>" + 
						"<th style=\"width: 10%;\">" + messages.debutdevalidite() + "</th>" + 
						"<th style=\"width: 10%;\">" + messages.findevalidite() + "</th>" + 
						"<th style=\"width: 8%;\">" + messages.delegationstatus() + "</th>" + 
						"<th style=\"width: 8%;\">" + messages.type() + "</th>" + 
					"</tr>" + 
				"</thead>");
	    	out.println("<tbody>");
