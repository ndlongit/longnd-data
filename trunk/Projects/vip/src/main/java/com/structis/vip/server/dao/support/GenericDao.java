...
public interface GenericDao<E extends Identifiable<PK>, PK extends Serializable> {
    ...
    /**
     * Gets from the repository the E entity instance whose primary key or unique field matches the corresponding primary key or unique field of the
     * passed E instance.
     * 
     * DAO for the local database will typically use the primary key or unique fields of the passed entity, while DAO for external repository may use
     * a unique field present in the entity as they probably have no knowledge of the primary key. Hence, passing the entity as an argument instead of
     * the primary key allows you to switch the DAO more easily.
     * 
     * @param entity
     *            a E instance having a primary key or a unique field set
     ...
     * 
     * @param entities
     *            the list of entities to be saved or updated.
     */
     ...
     * 
     * @param entity
     *            a sample entity whose non-null properties may be used as search hints
     ...
     * 
     * @param entity
     *            a sample entity whose non-null properties may be used as search hint
     * @param searchTemplate
     *            carries additional search information
