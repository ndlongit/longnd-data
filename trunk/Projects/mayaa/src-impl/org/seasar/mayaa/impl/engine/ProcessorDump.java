...
public class ProcessorDump extends ElementProcessor {
    // TODO EchoProcessor繧堤ｶ呎価縺励※菴ｿ縺｣縺ｦ縺�ｋ驛ｨ蛻�ｒ縺ｾ縺ｨ繧√ｋ
    // TODO ServiceProvider縺ｧ蟾ｮ縺玲崛縺亥庄閭ｽ縺ｫ縺吶ｋ
...
//            }
    ...
    protected SpecificationNode getNode(TemplateProcessor processor) {
        if (processor instanceof ElementProcessor) {
            ...
            if (ep.isDuplicated()) {
                // TODO templateElement繧ＰriginalNode縺ｫ縺吶ｋ
...
//            attrPrefix = getResolvedPrefix(propName);
        ...
        /* 2007.03.15 value縺系ull縺ｮ蝣ｴ蜷医ｒ險ｱ螳ｹ縺吶ｋ(蛟､縺ｪ縺励ｒ菴懈�蜿ｯ閭ｽ縺ｫ) */
        if (value != null) {
	        temp.append("=\"");
