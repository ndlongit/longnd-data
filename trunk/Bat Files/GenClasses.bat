...
echo public class %MODEL_CLASS% implements %BASIC_MODEL%^<%NUMERIC_ID_TYPE%^>{}>> %MODEL_FILE%

set DAO_FILE="%JAVA_FOLDER%\%DAO_FOLDER%\%MODEL_CLASS%Dao%MODEL_EXTENSION%"
copy /Y nul %DAO_FILE%
echo package %BASE_PACKAGE%.%DAO_PACKAGE%;>> %DAO_FILE%
echo package %BASE_PACKAGE%.%DAO_PACKAGE%.core.%BASIC_DAO%;>> %DAO_FILE%
...
echo public class %MODEL_CLASS%ServiceImpl extends %BASIC_SERVICE%Impl^<%MODEL_CLASS%, %NUMERIC_ID_TYPE%, %MODEL_CLASS%Dao^> implements %MODEL_CLASS%Service {}>> %SERVICE_IMPL_FILE%
REM ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
