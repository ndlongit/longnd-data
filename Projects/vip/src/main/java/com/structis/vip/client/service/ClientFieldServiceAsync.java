...
public interface ClientFieldServiceAsync {
    ...
    public static class Util {
        ...
        private static ClientFieldServiceAsync instance = GWT.create(ClientFieldService.class);
    ...
    void getFieldsByGroupName(String entId, String groupName, AsyncCallback<List<FieFieldModel>> callback);
