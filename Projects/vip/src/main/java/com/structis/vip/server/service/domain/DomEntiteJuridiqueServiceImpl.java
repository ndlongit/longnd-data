...
public class DomEntiteJuridiqueServiceImpl extends GenericEntityServiceImpl<EntiteJuridique, Integer>
		implements DomEntiteJuridiqueService {

	@SuppressWarnings("unused")
	private static final Logger LOGGER = Logger
			.getLogger(DomEntiteJuridiqueServiceImpl.class);
