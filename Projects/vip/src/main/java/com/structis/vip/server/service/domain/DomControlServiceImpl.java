...
public class DomControlServiceImpl extends GenericEntityServiceImpl<Control, Integer> implements
		DomControlService {
	...
	@Override	
	public List<Control> getControlsByEntite(String enId,
			String perimetreId, List<Integer> keyList, Date startDate,
			Date endDate, String codeProjet, List<String> caracteres, String controllerName, PerimetreTreeModel perimetreTreeModel,
			List<UserRoleModel> userRoles) {
		return controlDao.getControlsByEntite(enId,
				perimetreId, keyList, startDate,
				endDate, codeProjet, caracteres, controllerName, perimetreTreeModel,
				userRoles);
	}

	@Override
	public List<Control> findByPerimetre(String perId) {
		return controlDao.getControlsByPerimetre(perId);
	}
}
