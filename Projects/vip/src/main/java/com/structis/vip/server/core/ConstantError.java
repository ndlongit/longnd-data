...
public class ConstantError {
    ...
    /**
     * Functional error commence par f
     */
    public static final String ERR_PRODUIT_NOTFOUND = "f001";
    public static final String ERR_FCG_NOTFOUND = "f002";
    public static final String ERR_UPDATE_FCG = "f003";
    public final static String ERR_ACCES_REFUSE = "f004";
    public final static String ERR_PRODUIT_DOUBLON = "f005";
    public final static String ERR_PRODUIT_ATTACHE = "f006";
    public final static String ERR_UNITE_ATTACHE = "f007";
    public final static String ERR_PRODUIT_CHAR_ATTACHE = "f008";
