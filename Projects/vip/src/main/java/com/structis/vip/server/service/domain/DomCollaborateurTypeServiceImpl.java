...
public class DomCollaborateurTypeServiceImpl extends GenericEntityServiceImpl<CollaborateurType, Integer> implements DomCollaborateurTypeService {
    ...
    public GenericDao<CollaborateurType, Integer> getDao() {
        return this.collaborateurTypeDao;
    }
    ...
    public List<CollaborateurType> getCollaborateurTypeByEntite(String entiteId) {
        return this.collaborateurTypeDao.getCollaborateurTypeByEntite(entiteId);
    }

    @Override
    public CollaborateurType insert(CollaborateurType doc) {
        return this.collaborateurTypeDao.insert(doc);
    }

    @Override
    public CollaborateurType update(CollaborateurType doc) {
        return this.collaborateurTypeDao.update(doc);
    }
