...
public class DomChantierTypeServiceImpl extends GenericEntityServiceImpl<ChantierType, Integer> implements
		DomChantierTypeService {
	...
	public List<ChantierType> findChantierByEntite(String entiteId) {
		return chantierTypeDao.findChantierByEntite(entiteId);
	}

	@Override
	public ChantierType insert(ChantierType nature) {
		return chantierTypeDao.insert(nature);
	}

	@Override
	public ChantierType update(ChantierType nature) {
		return chantierTypeDao.update(nature);
	}
