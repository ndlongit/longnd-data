...
public class DomCategoryServiceImpl extends GenericEntityServiceImpl<Category, Integer>
		implements DomCategoryService {

	@SuppressWarnings("unused")
	private static final Logger LOGGER = Logger
			.getLogger(DomCategoryServiceImpl.class);
	...
	public Category insert(Category doc) {
		return categoryDao.insert(doc);
	}

	@Override
	public Category update(Category doc) {
		return categoryDao.update(doc);
	}
