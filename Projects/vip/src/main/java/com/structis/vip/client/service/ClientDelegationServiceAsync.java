...
public interface ClientDelegationServiceAsync {
    ...
    void insertRenew(DelegationModel delegationModel, AsyncCallback<DelegationModel> callback);

    void updateStatusAuto(DelegationModel delegationModel, AsyncCallback<Boolean> callback);

    void findByPerimetre(String perimetreId, AsyncCallback<List<DelegationModel>> callback);

    void getValidDelegationsByEntiteByPaging(DelegationFilter filter, AsyncCallback<PagingLoadResult<DelegationModel>> callback);
