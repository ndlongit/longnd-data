...
public class DomDocTypeServiceImpl extends GenericEntityServiceImpl<DocumentType, Integer>
		implements DomDocTypeService {

	@SuppressWarnings("unused")
	private static final Logger LOGGER = Logger
			.getLogger(DomDocTypeServiceImpl.class);
	...
	public DocumentType insert(DocumentType doc) {
		return docTypeDao.insert(doc);
	}

	@Override
	public DocumentType update(DocumentType doc) {
		return docTypeDao.update(doc);
	}
