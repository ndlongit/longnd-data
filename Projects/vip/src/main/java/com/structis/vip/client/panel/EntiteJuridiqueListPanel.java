...
public class EntiteJuridiqueListPanel extends LayoutContainer {
	...
	private void initData() {
		...
		clientEntiteJuridiqueService.findByEntiteId(SessionServiceImpl.getInstance().getEntiteContext().getEntId(), new AsyncCallback<List<EntiteJuridiqueModel>>() {
					@Override
		...
		final Listener<MessageBoxEvent> l = new Listener<MessageBoxEvent>() {
			public void handleEvent(MessageBoxEvent ce) {
				...
				if (txtReturn.equals(btn.getText())) {
					...
					clientEntiteJuridiqueService.delete(model, new AsyncCallback<Boolean>() {
						@Override
	...
	private void initUI() {
		...
		GridCellRenderer<EntiteJuridiqueModel> defaultRender = new GridCellRenderer<EntiteJuridiqueModel>() {
			@Override
			public Object render(final EntiteJuridiqueModel model, String property,
				...
				cb.addListener(Events.OnClick, new Listener<BaseEvent>() {
					...
					public void handleEvent(BaseEvent be) {
						...
						for (EntiteJuridiqueModel item : store.getModels()) {
							...
							item.setIsDefault(0);
							clientEntiteJuridiqueService.update(item, new AsyncCallback<EntiteJuridiqueModel>() {
								@Override
						...
						clientEntiteJuridiqueService.update(model, new AsyncCallback<EntiteJuridiqueModel>() {
							@Override
							public void onSuccess(EntiteJuridiqueModel arg0) {
								initData();
							}
