...
public interface ClientCollaborateurServiceAsync {
	...
	void getAllCollaborateursByEntiteId(String entiteId, Boolean sortie, String sortedField, Integer sortDir, Integer start, Integer pageSize, AsyncCallback<List<CollaborateurModel>> callback);
	...
	void update(CollaborateurModel model,
			AsyncCallback<CollaborateurModel> callback);

	void findByName(String name, String entityId, Boolean sortie, 
	...
	void insert(CollaborateurModel model,
			AsyncCallback<CollaborateurModel> callback);

	void findByCollaborateurId(Integer colId,
			AsyncCallback<List<CollaborateurFormationModel>> callback);

	void updateAndFormation(CollaborateurModel model,
			AsyncCallback<CollaborateurModel> callback);

	void updatePerimetreDelegant(Integer id, String perId,
			AsyncCallback<CollaborateurModel> asyncCallback);

	void updatePerimetreDelegataire(Integer id, String perId,
			AsyncCallback<CollaborateurModel> asyncCallback);
	
	void getAllDelegantsByPerimeter(String perId,String entiteId, 
			AsyncCallback<List<CollaborateurModel>> asyncCallback);
	
	void getAllDelegatairesByPerimeter(String perId,String entiteId,
			AsyncCallback<List<CollaborateurModel>> asyncCallback);

	void findByFormationId(Integer forId,
			AsyncCallback<List<CollaborateurFormationModel>> callback);

	void getAllCollaborateursByEntiteIdPaging(PagingLoadConfig loadConfig,
			String entId, 
			AsyncCallback<PagingLoadResult<CollaborateurModel>> callback);

	void getDelegantsByNatureAndPerimetre(String perId, String ptyId, String entId, Integer natureId,
			AsyncCallback<List<CollaborateurModel>> asyncCallback);

	void getAllControleursByEntiteId(String entiteIdIsByefe, 
			AsyncCallback<List<KeyValueModel>> asyncCallback);
	void findById(Integer colId,
			AsyncCallback<CollaborateurModel> callback);

	void getAndUpdate(CollaborateurModel model,
			AsyncCallback<CollaborateurModel> asyncCallback);
