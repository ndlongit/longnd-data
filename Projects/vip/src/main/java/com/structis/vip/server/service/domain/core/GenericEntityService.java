...
public interface GenericEntityService<T extends Identifiable<PK>, PK extends Serializable> {
    ...
    /**
     * Create a new instance. This method may be convenient when you need to instanciate an entity from a Spring Web Flow script.
     * 
    ...
    /**
     * Creates a new instance and initializes it with some default values. This method may be convenient when you need to instanciate an entity from a
     * Spring Web Flow script.
     * 
    ...
    /**
     * Get an entity based on the passed example. If the example has a primary key set, it will be used. Otherwise if the example has unique field
     * set, it will be used to lookup the entity.
     * 
     * @param example
     ...
     * 
     * @param primaryKey
     *            the primaryKey identifying the entity to delete.
     */
     ...
     *             if no entity or more than one entity is found.
     */
