...
public interface ClientExternControllerControlServiceAsync {
    ...
    void insert(ExtControllerControlModel model, AsyncCallback<ExtControllerControlModel> callback);

    void update(ExtControllerControlModel model, AsyncCallback<ExtControllerControlModel> callback);
    ...
    void deleteByControl(Integer control, AsyncCallback<Boolean> asyncCallback);

    void insert(List<ExtControllerControlModel> eccs, AsyncCallback<Void> asyncCallback);

    void insert(Integer controlId, List<ExtControllerControlModel> eccs, AsyncCallback<Void> asyncCallback);
}
