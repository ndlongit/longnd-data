...
public class WsLienResultType implements java.io.Serializable {
    ...
    private com.structis.argos.ws.WsLienType[] listeRetour;

    public WsLienResultType() {
    }

    public WsLienResultType(java.lang.String messageErreur, int codeRetour, com.structis.argos.ws.WsLienType[] listeRetour) {
    ...
    /**
     * Gets the messageErreur value for this WsLienResultType.
     * 
    ...
    /**
     * Sets the messageErreur value for this WsLienResultType.
     * 
     * @param messageErreur
     */
    ...
    /**
     * Gets the codeRetour value for this WsLienResultType.
     * 
     * @return codeRetour
     */
    ...
    /**
     * Sets the codeRetour value for this WsLienResultType.
     * 
     * @param codeRetour
     */
    ...
    /**
     * Gets the listeRetour value for this WsLienResultType.
     * 
     * @return listeRetour
     */
    public com.structis.argos.ws.WsLienType[] getListeRetour() {
        return this.listeRetour;
    }

    /**
     * Sets the listeRetour value for this WsLienResultType.
     * 
     * @param listeRetour
     */
    public void setListeRetour(com.structis.argos.ws.WsLienType[] listeRetour) {
        this.listeRetour = listeRetour;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WsLienResultType))
            return false;
        WsLienResultType other = (WsLienResultType) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(WsLienResultType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.argos.structis.com", "WsLienResultType"));
