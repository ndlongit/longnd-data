/**
 * WsArbreOrganisationResultType.java
 *
...
public class WsArbreOrganisationResultType  implements java.io.Serializable {
    ...
    private com.structis.argos.ws.WsArbreOrganisationType[] listeRetour;
     ...
     * @param listeRetour
     */
    public void setListeRetour(com.structis.argos.ws.WsArbreOrganisationType[] listeRetour) {
        this.listeRetour = listeRetour;
    }
