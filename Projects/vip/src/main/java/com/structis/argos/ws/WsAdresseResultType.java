...
public class WsAdresseResultType implements java.io.Serializable {
    ...
    private com.structis.argos.ws.WsAdresseType[] listeRetour;

    public WsAdresseResultType() {
    }

    public WsAdresseResultType(java.lang.String messageErreur, int codeRetour, com.structis.argos.ws.WsAdresseType[] listeRetour) {
    ...
    /**
     * Gets the messageErreur value for this WsAdresseResultType.
     * 
    ...
    /**
     * Sets the messageErreur value for this WsAdresseResultType.
     * 
     * @param messageErreur
     */
    ...
    /**
     * Gets the codeRetour value for this WsAdresseResultType.
     * 
     * @return codeRetour
     */
    ...
    /**
     * Sets the codeRetour value for this WsAdresseResultType.
     * 
     * @param codeRetour
     */
    ...
    /**
     * Gets the listeRetour value for this WsAdresseResultType.
     * 
     * @return listeRetour
     */
    public com.structis.argos.ws.WsAdresseType[] getListeRetour() {
        return this.listeRetour;
    }

    /**
     * Sets the listeRetour value for this WsAdresseResultType.
     * 
     * @param listeRetour
     */
    public void setListeRetour(com.structis.argos.ws.WsAdresseType[] listeRetour) {
        this.listeRetour = listeRetour;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WsAdresseResultType))
            return false;
        WsAdresseResultType other = (WsAdresseResultType) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(WsAdresseResultType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.argos.structis.com", "WsAdresseResultType"));
