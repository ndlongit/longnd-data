...
public class MainFrame extends JFrame {
    ...
    private void initData() {
        ...
        if (DEBUG) {
            ...
            String keySize = "56";
            this.txtInputFile.setText(inputFile);
            this.txtKeyFile.setText(keyFile);
            this.txtPublicKey.setText(pubKeyFile);
            this.txtOutputFile.setText(outputFile);
            this.txtKeySize.setText(keySize);
            this.jPasswordField1.setText("123456");
            this.cmbAlgorithmSymC.setSelectedItem(AsymmetricEncrypter.RSA);
        }
    }
