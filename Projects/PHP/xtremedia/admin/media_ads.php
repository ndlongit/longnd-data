...
if ($mode == 'edit') {
	...
	if ($ads_id) {
		...
		while ($r = $mysql->fetch_array($q)) {
			echo "<tr align=center class=fr><td><a href=?act=ads&mode=del&ads_id=".$r['ads_id']."'>DEL</a> - <a href=\"$link&ads_id=".$r['ads_id']."\"><b>".$r['ads_web']."</b></a></td><td class=fr_2><a href=\"".$r['ads_url']."\" target=_blank><b>".$r['ads_url']."</b></a></td><td class=fr><img src=\"".$r['ads_img']."\" width=140></td></tr>";
		}
