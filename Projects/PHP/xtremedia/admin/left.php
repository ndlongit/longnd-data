...
$menu_arr = array(
	...
	'request'	=>	array(
		'Yêu Cầu Nhạc',
		array(
			'edit'    =>    array('Quản lý Yêu cầu nhạc','act=request&mode=view'),
		),
	),
	'singer'	=>	array(
		'Ca sỹ',
	...
	'news_cat'	=>	array(
		'Thể loại Tin Tức',
		array(
			'edit'	=>	array('Quản lý Thể loại','act=news_cat&mode=edit'),
			'add'	=>	array('Thêm Thể loại','act=news_cat&mode=add'),
		),
	),
	'news'    =>    array(
        'Tin tức',
        array(
            'edit'    =>    array('Quản lý tin tức','act=news&mode=edit'),
	...
	'config'	=>	array(
		...
		array(
			...
			'site_off'	=>	array('Đóng cửa Website','act=site_off'),
