...
if (($value[0] == 'Search' || $value[0] == 'Quick_Search') && isset($value[1],$value[2])) {
	...
	else echo "<b>Dữ liệu với <font color=red>[từ khóa]</font> bạn đang tìm không có trong mục này, bạn hãy thử tìm kiếm theo hướng khác? Chúng tôi có 3 hướng tìm kiếm cho bạn:<br/> <center><font color=red>[tìm theo ca sỹ]</font> - <font color=red>[tìm theo bài hát]</font> - <font color=red>[tìm theo album]</font></center><br/><br/>Chúng tôi rất xin lỗi vì điều này, chúng tôi sẽ cố gắng cập nhật trong thời gian sớm nhất có thể, xin vui lòng trở lại tìm kiếm dữ liệu này vào lúc khác! Xin Cảm Ơn!</b>";
}
?>