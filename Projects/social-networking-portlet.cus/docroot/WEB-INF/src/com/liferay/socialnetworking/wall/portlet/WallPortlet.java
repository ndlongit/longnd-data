...
public class WallPortlet extends MVCPortlet {
    ...
    public void updateWallEntry(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
        
        UploadPortletRequest uploadRequest = PortalUtil.getUploadPortletRequest(actionRequest);
        long wallEntryId = ParamUtil.getLong(uploadRequest, "wallEntryId");

        try {
            String comments = ParamUtil.getString(uploadRequest, "comments");
            WallEntryLocalServiceUtil.updateWallEntry(wallEntryId, comments);
        }
        catch (Exception e) {
            return;
        }
