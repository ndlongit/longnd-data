...
import static com.structis.fichesst.shared.security.Droits.b_admin;
import static com.structis.fichesst.shared.security.Droits.anonymous;;

/**
 * Enum pour l'action, l'ajoute d'un action commence par ici
 * Il est d�fini pour assurer que l'appel est fait sur une action existant
 * Regle de nommage :
 * <ul> 
 ...
 */
public enum Action {
	ACTION_ERROR("actionError",anonymous),
	ACTION_ACCEUIL("actionAcceuil",anonymous), 
	ACTION_ADMIN("actionAdmin",b_admin),
/*	ACTION_SYNTHESE("actionSynthese",b_admin),*/
	ACTION_SYNTHESE_CREATE("actionSyntheseCreate",anonymous),
	ACTION_USER("actionUser",anonymous),
	ACTION_CREATE_FICHESST("actionCreateFICHESST",anonymous),
	;
