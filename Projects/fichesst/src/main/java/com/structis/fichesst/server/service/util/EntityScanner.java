package com.structis.fichesst.server.service.util;
...
public class EntityScanner implements ApplicationContextAware, PersistenceUnitPostProcessor {
	...
	/**
	 * Set whether to use Spring-based scanning for entity classes in the classpath instead of listing annotated classes
	 * explicitly.
	 * <p>
	 * Default is none. Specify packages to search for autodetection of your entity classes in the classpath. This is
	 * analogous to Spring's component-scan feature (org.springframework.context.annotation.ClassPathBeanDefinitionScanner}).
	 */
