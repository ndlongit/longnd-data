...
public class MemgmmgrBaseNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _MemgmmgrBaseNames extends PropertyName<Memgmmgr> {

        /**
         * インスタンスを構築します。
         */
        public _MemgmmgrBaseNames() {
            super();
        }
         ...
         *            名前
         */
        public _MemgmmgrBaseNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _MemgmmgrBaseNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
