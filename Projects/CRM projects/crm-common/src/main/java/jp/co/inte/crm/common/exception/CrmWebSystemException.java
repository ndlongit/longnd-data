 ...
 * @since 1.0
 */
public class CrmWebSystemException extends AbstractFwSiteSystemException implements FwForwardable {
     ...
     */
    public CrmWebSystemException(String errorCode, String msg, String... params) {
     ...
     * @param cause 例外
     */
    public CrmWebSystemException(String errorCode, Throwable cause) {
     ...
     * @param params メッセージプレースホルダー置換パラメーター
     */
    public CrmWebSystemException(String errorCode, Throwable cause, String message,
            String... params) {
