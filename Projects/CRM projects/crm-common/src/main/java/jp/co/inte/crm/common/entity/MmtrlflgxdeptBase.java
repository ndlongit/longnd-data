...
public class MmtrlflgxdeptBase extends CrmBaseEntity implements Serializable {
    ...
    /** フラグNo */
    @Column(precision = 2, nullable = true, unique = true)
    ...
    /** mmtrlflgList関連プロパティ */
    @OneToMany(mappedBy = "mmtrlflgxdept")
    public List<Mmtrlflg> mmtrlflgList;
